...
import { DeleteListUseCase } from "../../usecases/DeleteList";
...
describe("DeleteListUseCase", () => {
  ...
  test("should handle different user roles correctly", async () => {
    const testCases = [
      { role: 'OWNER' as BoardRole, shouldSucceed: true },
      { role: 'ADMIN' as BoardRole, shouldSucceed: true },
      { role: 'MEMBER' as BoardRole, shouldSucceed: true },
      { role: 'VIEWER' as BoardRole, shouldSucceed: false },
